...
抓取入口：http://xy.scau.edu.cn/linxue/linxuejob/list.asp?classid=20
"""

url_hire = "http://xy.scau.edu.cn/linxue/linxuejob/list.asp?classid=20&page={0}"
...
def get_page_num():
    ...
    html=get_html_t(url)
    page_re=re.findall(r">\.\.\.(\d+)",html)
    return int(page_re[0])
...
def fetch():
    ...
    for info in infos:
        ...
        info['title']=title
        info['web_url']=url
        info['message_source']="林学与风景园林学院官网"
        info['job_type']=0
